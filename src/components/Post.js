...
export default function Post() {
  ...
  return (
    <div className='bg-scroll bg-contain overflow-auto w-cover h-cover'>
        <img src={image} alt='blurred tan background' className='absolute object-cover w-cover h-cover'/>
        <section className='container mx-auto absolute justify-center min-h-screen pt-5 lg:pt-8 px-8'>
            ...
            <h2 className="text-lg text-gray-500 flex justify-center mb-12 featured-posts-sub">
